...
linkml_meta = LinkMLMeta(
    {
        "default_prefix": "https://echemdb.github.io/metadata-schema/source_data/",
        "default_range": "string",
        "description": "Metadata schema for source data files in echemdb.",
        "id": "https://echemdb.github.io/metadata-schema/source_data",
        "imports": [
            "linkml:types",
            "./curation",
            "./system",
...
class ElectrodeSource(ConfiguredBaseModel):
    ...
    manufacturer: Optional[str] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {
                "alias": "manufacturer",
                "domain_of": ["ElectrodeSource", "ComponentSource", "Instrumentation"],
    ...
    model: Optional[str] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {
                "alias": "model",
                "domain_of": ["ElectrodeSource", "Instrumentation"],
...
class Component(ConfiguredBaseModel):
    ...
    flow: Optional[Quantity] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {
                "alias": "flow",
                "domain_of": ["Component", "MassTransport"],
...
class DataDescription(ConfiguredBaseModel):
    """
    Description of the raw data file format, including CSV dialect, field mapping from original headers to standardized names, and units for each field.
    """
    ...
    dialect: Optional[Dialect] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"alias": "dialect", "domain_of": ["DataDescription"]}
        },
    )
    fieldUnits: Optional[list[FieldUnit]] = Field(
        default=None,
        description="""List of fields with their units and optional reference electrodes. Describes the physical units of each data column after mapping.""",
        json_schema_extra={
            "linkml_meta": {"alias": "fieldUnits", "domain_of": ["DataDescription"]}
        },
    )


class Dialect(ConfiguredBaseModel):
    """
    ...
    encoding: Optional[str] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {
                "alias": "encoding",
                "domain_of": ["Dialect"],
                "examples": [{"value": "utf-8"}, {"value": "latin-1"}],
            }
        },
    )
    headerLines: Optional[int] = Field(
        default=None,
    ...
    columnHeaderLines: Optional[int] = Field(
        default=None,
...
class FieldUnit(ConfiguredBaseModel):
    """
    ...
    name: str = Field(
        ...
        json_schema_extra={
            "linkml_meta": {
                ...
                "examples": [{"value": "E"}, {"value": "j"}, {"value": "t"}],
            }
        },
    )
    unit: str = Field(
    ...
    description: Optional[str] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {
                ...
                "examples": [
                    {
                        "value": "Electrode potential vs. reversible hydrogen "
                        "electrode"
                    }
                ],
            }
...
class SourceData(ConfiguredBaseModel):
    """
    ...
    curation: Curation = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"alias": "curation", "domain_of": ["SourceData"]}
        },
    )
    system: System = Field(
        default=...,
        ...
        json_schema_extra={
            "linkml_meta": {"alias": "system", "domain_of": ["SourceData"]}
        },
    )
    source: Source = Field(
        default=...,
    ...
    experimental: Experimental = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"alias": "experimental", "domain_of": ["SourceData"]}
        },
    )
    figureDescription: FigureDescription = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"alias": "figureDescription", "domain_of": ["SourceData"]}
        },
    )
    dataDescription: DataDescription = Field(
        default=...,
        description="""Description of the raw data file format.""",
        json_schema_extra={
            "linkml_meta": {"alias": "dataDescription", "domain_of": ["SourceData"]}
        },
    )
