...
class MassTransport(ConfiguredBaseModel):
    ...
    flow: Optional[Flow] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"domain_of": ["Component", "MassTransport"]}
        },
    )
...
class DataDescription(ConfiguredBaseModel):
    ...
    dialect: Optional[Dialect] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["DataDescription"]}},
    )
...
class Dialect(ConfiguredBaseModel):
    ...
    headerLines: Optional[int] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"domain_of": ["Dialect"], "examples": [{"value": "5"}]}
        },
    )
    columnHeaderLines: Optional[int] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"domain_of": ["Dialect"], "examples": [{"value": "2"}]}
        },
    )
...
class SourceData(ConfiguredBaseModel):
    ...
    curation: Curation = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["SourceData"]}},
    )
    system: System = Field(
        default=...,
