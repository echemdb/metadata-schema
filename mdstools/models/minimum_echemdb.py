...
linkml_meta = LinkMLMeta(
    {
        "default_prefix": "https://echemdb.github.io/metadata-schema/minimum_echemdb/",
        "default_range": "string",
        "description": "Minimum set of metadata to describe an electrochemical system "
        "for echemdb.",
        "id": "https://echemdb.github.io/metadata-schema/minimum_echemdb",
        "imports": [
            "linkml:types",
            "./curation",
            "./system",
        ...
        "source_file": "D:\\github\\echemdb\\metadata-schema\\linkml\\minimum_echemdb.yaml",
    }
)
...
class MinimumEchemdb(ConfiguredBaseModel):
    """
    ...
    curation: Curation = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"alias": "curation", "domain_of": ["MinimumEchemdb"]}
        },
    )
    system: System = Field(
        default=...,
        ...
        json_schema_extra={
            "linkml_meta": {"alias": "system", "domain_of": ["MinimumEchemdb"]}
        },
    )
    ...
    experimental: Experimental = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"alias": "experimental", "domain_of": ["MinimumEchemdb"]}
        },
    )
    source: Source = Field(
        default=...,
